...
<button type="button" class="btn btn-primary d-inline" data-toggle="modal" data-target="#addPurchaseOrderModal">Add Purchase Order</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addConsumptionModalLabel">Add Purchase Order</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="{{url('purchase-order/add')}}" method="post" id="addForm">
        @csrf
        <div class="container">
